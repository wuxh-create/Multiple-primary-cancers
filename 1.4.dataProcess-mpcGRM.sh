...
ukb_bfile="/home/luohh/UKB50wMultiPcancer/01.data/01.genoData/01.MPC/merge"
...
output_path="/home/luohh/UKB50wMultiPcancer/01.data/03.grmData/01.MPC/"
#job_id=${SGE_TASK_ID}
...
cat ${output_path}UKB_GRM_parts.part_200_*.grm.id > ${output_path}UKB_GRM.grm.id
cat ${output_path}UKB_GRM_parts.part_200_*.grm.bin > ${output_path}UKB_GRM.grm.bin
cat ${output_path}UKB_GRM_parts.part_200_*.grm.N.bin > ${output_path}UKB_GRM.grm.N.bin

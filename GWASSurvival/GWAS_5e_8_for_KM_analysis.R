...
for (snp in snp_columns) {
  ...
  # 创建PDF
  pdf(paste0("/home/wuxh/03.MultiPCancer/luohh/UKB50wMultiPcancer/05.otherAnalysis/04.gwasSurvival/06.GWASSurvival_5e_8_SNP_Survival/",
             snp,".pdf"),5, 5)
...
write.table(p_values_df,
            paste0("/home/wuxh/03.MultiPCancer/luohh/UKB50wMultiPcancer/05.otherAnalysis/04.gwasSurvival/06.GWASSurvival_5e_8_SNP_Survival/z_snp_p_values"), 

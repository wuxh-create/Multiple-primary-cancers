...
cancerSampleList = []
with open("/home/luohh/UKB50wMultiPcancer/01.data/02.phenoData/01.MPC/GWAS.pheno","r") as fi:
    for line in fi:
...
fo = open("/home/luohh/UKB50wMultiPcancer/05.otherAnalysis/04.gwasSurvival/01.data/02.phenoData/clinic.tsv","w")

...
### 基因型协变量 SNV
snvPcaInfoDict = {}
with open("/home/luohh/UKB50wMultiPcancer/05.otherAnalysis/05.caseCaseGWAS/01.data/02.phenoData/pca40.snv.eigenvec","r") as fi:
    for line in fi:
        data = line.strip().split("\t")
...
if sys.argv[2] == "singleSex":
    fo = open("/home/luohh/UKB50wMultiPcancer/05.otherAnalysis/05.caseCaseGWAS/01.data/02.phenoData/"+sys.argv[1]+"/GWAS.last.qcovar","w")

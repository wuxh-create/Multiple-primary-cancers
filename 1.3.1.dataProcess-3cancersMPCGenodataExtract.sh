...
outputPath='/home/wuxh/03.MultiPCancer/luohh/UKB50wMultiPcancer/01.data/01.genoData/03.3cancersMPC'
...
read -u1000
{
	/home/wuxh/software/plink2 --bgen $UKBGenoData/ukb_imp_chr${chr}_v3.bgen 'ref-first' --sample $UKBGenoData/ukb_imp_chr${chr}_v3.sample --exclude ${excludeVar} --keep ${keepSample}  --maf 0.0001 --max-maf 0.9999 --geno 0.05 --make-bed --out ${outputPath}/chr${chr}
	echo >&1000
}&
done
wait

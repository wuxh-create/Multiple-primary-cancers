...
variable_names = [
    "PrediXcan_Adipose_Subcutaneous",
    "PrediXcan_Brain_Spinal_cord_cervical_c-1",
    "PrediXcan_Nerve_Tibial",
    "PrediXcan_Adipose_Visceral_Omentum",
    "PrediXcan_Brain_Substantia_nigra",
    "PrediXcan_Ovary",
    "PrediXcan_Adrenal_Gland",
    "PrediXcan_Breast_Mammary_Tissue",
    "PrediXcan_Pancreas",
    "PrediXcan_Artery_Aorta",
    "PrediXcan_Cells_Cultured_fibroblasts",
    "PrediXcan_Pituitary",
    "PrediXcan_Artery_Coronary",
    "PrediXcan_Cells_EBV-transformed_lymphocytes",
    "PrediXcan_Prostate",
    "PrediXcan_Artery_Tibial",
    "PrediXcan_Colon_Sigmoid",
    "PrediXcan_Skin_Not_Sun_Exposed_Suprapubic",
    "PrediXcan_Brain_Amygdala",
    "PrediXcan_Colon_Transverse",
    "PrediXcan_Skin_Sun_Exposed_Lower_leg",
    "PrediXcan_Brain_Anterior_cingulate_cortex_BA24",
    "PrediXcan_Esophagus_Gastroesophageal_Junction",
    "PrediXcan_Small_Intestine_Terminal_Ileum",
    "PrediXcan_Brain_Caudate_basal_ganglia",
    "PrediXcan_Esophagus_Mucosa",
    "PrediXcan_Spleen",
    "PrediXcan_Brain_Cerebellar_Hemisphere",
    "PrediXcan_Esophagus_Muscularis",
    "PrediXcan_Stomach",
...
base_command = (
    "/home/wuxh/03.MultiPCancer/05.TWAS/01.install.software/MetaXcan/software/SPrediXcan.py "
    ...
    "--gwas_file_pattern 'fastGWA_GLMM_final.fastGWA' "
    "--snp_column SNP --effect_allele_column A1 --non_effect_allele_column A2 --beta_column BETA --pvalue_column P "
    "--output_file /home/wuxh/03.MultiPCancer/05.TWAS/03.result/allGWAS_res/{output_file}"
)
# 遍历变量名称列表，构建并执行命令

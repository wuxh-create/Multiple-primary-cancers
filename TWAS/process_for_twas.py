...
base_command = (
    ...
    "--model_db_path /home/wuxh/luohh/07.TWAS/01.install.software/MR-JTI/pre-training/{db_path} "
    "--covariance /home/wuxh/luohh/07.TWAS/01.install.software/MR-JTI/pre-training/{cov_path}.txt.gz "
    "--gwas_folder /home/luohh/UKB50wMultiPcancer/03.result/01.MPC "
